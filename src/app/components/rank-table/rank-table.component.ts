...
@Component({
  ...
  standalone: true,
  imports: [DropdownModule,CommonModule,FormsModule,CtableComponent,TableModule,RatingModule,TagModule],
              ...
              this.ranks.push(
                {
                  ...
                  L:rk.all.lose,
                  poin:rk.points,
                  lasts:this.getMatchsReviews(rk.team.id,numb)
                }
              )
              i++;
              if(i==5){
